...
const router = () => {
    ...
    const routerCall = async function (req, res, next) {
        const { queue: parentQueue, queueIndex: parentIndex, prefixSegments: parentPrefixSegments, pathname: fullPathname, method } = req;
